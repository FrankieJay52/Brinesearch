...
async function main() {
  ...
  console.log(JSON.stringify({
    ...
    productionWrites: result.ledger.authority.productionWrites,
    migrationsApplied: result.ledger.authority.migrationsApplied,
    releaseState: result.ledger.productionApplication.releaseState,
    graphChanges: 0,
