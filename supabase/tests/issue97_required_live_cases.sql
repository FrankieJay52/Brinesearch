    ...
    where actual.county_count<>expected.county_count
	  ...
	  if exists(
	    with expected(state_code,county_code,county_name,county_geoid,source_county_code) as (values
	      ...
	      ('OH','HAS','Harrison','39067','HAS'),('OH','JEF','Jefferson','39081','JEF'),
	      ('OH','MAH','Mahoning','39099','MAH'),('OH','MEG','Meigs','39105','MEG'),
	      ('OH','MOE','Monroe','39111','MOE'),
	      ...
	      ('OH','VIN','Vinton','39163','VIN'),('OH','WAS','Washington','39167','WAS'),
	      ('WV','BRO','Brooke','54009','05'),('WV','DOD','Doddridge','54017','09'),
	      ('WV','LEW','Lewis','54041','21'),('WV','MAR','Marion','54049','25'),
