...
if (!serviceWorker.includes("brinesearch-v17-3-15-global-written-directions")) throw new Error('V17.3.15 service-worker cache marker is missing.');
...
console.log(`Verified V${parts.version}: ${parts.parts.length} JS parts, ${styles.styles.length} CSS parts, bounded startup dependencies, saved-mileage rewrite safety, global written driver directions, conservative dual-name road support, synchronized well rows, and live-updating service worker. Build hashes: ${appSha256.slice(0,12)} / ${cssSha256.slice(0,12)}.`);
