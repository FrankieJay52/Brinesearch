...
for (const requiredDirectionToken of ['public_pad_detail', '__brineLiveClearDirectionsAuthoritative', 'directionClearPolishedStepsV1732', 'directionClearNoteOnlyV1732', 'directionSanitizeInstructionV1738', 'directionDriverSafeClearTextV1738']) {
...
if (!serviceWorker.includes("brinesearch-v17-3-8-direction-cleanup")) throw new Error('V17.3.8 service-worker cache marker is missing.');
...
console.log(`Verified V${parts.version}: ${parts.parts.length} JS parts, ${styles.styles.length} CSS parts, landmark-free driver direction display/copy, evidence-backed pad checks, richer driver route intelligence, richer official pad context after full selected-pad hydration, authoritative live Clear Directions, clean index, and live-updating service worker. Build hashes: ${appSha256.slice(0,12)} / ${cssSha256.slice(0,12)}.`);