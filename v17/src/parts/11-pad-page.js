        ...
        <div class="field-pad-page">
          ...
          <section class="field-pad-hero">
            ...
            <div class="field-main-actions">
              ${gmap ? `<a class="field-action primary field-action-visual field-action-directions" href="${esc(gmap)}" target="_blank" rel="noopener"><span class="field-action-emblem"><span class="fm-icon fm-directions-large"></span></span><span class="field-action-copy"><strong>${googleRouteReady ? (googleRouteChunks.length > 1 ? "Google route 1" : "Google Maps route") : "Google Maps GPS"}</strong><small>${googleRouteReady ? "Authoritative GPS-waypoint navigation" : "Exact pad pin only — route not yet verified"}</small></span></a>` : `<span class="field-action is-unavailable"><span class="fm-icon fm-warning"></span> No GPS saved — use written directions below</span>`}
              ${googleRouteChunks.slice(1).map(chunk => `<a class="field-action field-action-visual" href="${esc(chunk.url)}" target="_blank" rel="noopener"><span class="field-action-emblem"><span class="fm-icon fm-directions-large"></span></span><span class="field-action-copy"><strong>Continue route ${chunk.chunk}</strong><small>Starts at the previous chunk destination</small></span></a>`).join("")}
