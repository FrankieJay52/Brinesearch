...
| 7 | **WAMPUM** — `8e823835-2c10-4275-84e9-4067376fa364`; `ascent--wampum`; rev `1786258360881449`; Guernsey | I-70 → OH-285 → OH-313 → Salem Rd → Nighthawk Rd → Keep Right Onto Divison Rd → Lease Road | saved `39.962923,-81.440117` | Salem interior `39.941409,-81.446907`; Division / TR-59 interior `39.953452,-81.440293` | Exact Nighthawk occurrence is missing. Establish the I-70 exit, prove every ordered road from both origins, retain `Divison`/`Division` as a spelling alias rather than a new identity, and satellite-confirm the lease approach. |
| 8 | **SLABAUGH** — `eae4741b-7fb4-4bc3-8b20-26043032acda`; `ascent--slabaugh`; rev `1786265512886177`; Guernsey | I-70 → OH-285 → OH-313 → Salem Rd → Nighthawk Rd → Lease Road | saved `39.95541,-81.4408` | Salem interior lead `39.941409,-81.446907` | Exact Nighthawk control is missing, while later overlay context reports Division. Prove the actual occurrence and ordered road list from both origins; satellite-confirm the final approach without promoting the overlay label. |
