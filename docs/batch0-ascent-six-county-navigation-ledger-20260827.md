...
- Candidate implementation HEAD: `0752f2dc06ad2a24f5a23cd2c961a7de8e35572f`
- Candidate content SHA-256: `101d4df736f0cb18c306c8a370112ddbaa196a98ee46b14826c15410b630aa5d`
...
- `docs/ascent-gps-only-navigation-classification-20260831.csv`
- `docs/ascent-gps-only-navigation-classification-20260831.md`
- `docs/ascent-i70-navigation-wave-board-20260831.md`
...
- `docs/issue97-ascent-navigation-wave3-google-qa-draft-pr-20260831.md`
...
- DONE — reviewed ordered named roads to the saved or frozen destination pin: **87**
- GPS_ONLY — no reviewed named-road sequence yet: **160**
- No trusted GPS: **0**
...
The retained `current_state` values are audit provenance only: State 1 **1**, State 2 **8**, legacy GPS state **160**, and reviewed-handoff / graph-held **78**. They are not everyday driver grades or Navigate blockers. The twenty State-1 gates stay parked unless a later owner instruction explicitly says `PROMOTE <PAD NAME> TO STATE 1`.
...
- The generated CSV SHA-256 is `1fb0917b920e03953c406168e17a03ab8a17937014d0da1d88fef210c5f3300b`.
