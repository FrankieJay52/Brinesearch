...
- Candidate implementation HEAD: `ce331dfd39d1157782afa82bf14efcaaa6b33a8a`
- Candidate content SHA-256: `d7fec136bc74edcd1b1f3c48acd2784022c2f5a1db9449eb9d047331719eccc3`
...
- DONE — reviewed ordered named roads to the saved or frozen destination pin: **61**
- GPS_ONLY — no reviewed named-road sequence yet: **186**
- No trusted GPS: **0**
...
The retained `current_state` values are audit provenance only: State 1 **1**, State 2 **8**, legacy GPS state **186**, and reviewed-handoff / graph-held **52**. They are not everyday driver grades or Navigate blockers. The twenty State-1 gates stay parked unless a later owner instruction explicitly says `PROMOTE <PAD NAME> TO STATE 1`.
